...
|------|-------------|----------|------|----------|
| xianyu-Core | sunflowermm | [GitHub](https://github.com/sunflowermm/xianyu-Core) | 闲鱼 Webhook 通道 Core：`POST /webhook/xianyu` 接收外部 payload，经 OneBotv11 转发到指定群聊/私聊；含密钥鉴权与 commonconfig 配置 | ★★★★☆ |
